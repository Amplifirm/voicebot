...
export default function Bloomsberry() {
  ...
  return (
    <div className="min-h-screen bg-[#fef6e4]">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3 slide-in-left">
              {logoUrl ? (
                ...
                <div className="w-14 h-14 border-4 border-black bg-[#ff6b6b] rounded-xl flex items-center justify-center transform -rotate-6 pulse">
                  <span className="text-2xl">🍓</span>
                </div>
              )}
              <div>
                <h1 className="text-3xl font-black tracking-tight">BLOOMSBERRY</h1>
                <p className="text-xs font-bold tracking-wider text-[#ff6b6b]">LAUNCHING JANUARY 2026</p>
              </div>
            </div>
      ...
      {/* Hero */}
      <section className="max-w-6xl mx-auto px-8 py-20 relative overflow-hidden">
        <div className="absolute top-10 right-10 text-6xl float opacity-20">🍓</div>

        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="slide-in-left">
            <div className="inline-block border-3 border-black bg-[#ff6b6b] px-6 py-3 mb-8 transform -rotate-2 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rounded-xl">
              <span className="text-lg font-black text-white">COMING TO GORDON SQUARE, UCL</span>
            </div>
            
            <h2 className="text-7xl font-black leading-none mb-8">
              CHOCOLATE<br/>
              COVERED<br/>
            ...
            <div className="border-l-4 border-black pl-6 mb-8">
              ...
              <div className="border-3 border-black bg-[#ffe66d] p-4 mb-4 rounded-lg">
                <p className="text-lg font-black mb-2">🎉 LIMITED EARLY ACCESS</p>
            ...
            <div className="mb-6">
              <div className="flex gap-3">
                <input 
                  ...
                  className="flex-1 border-3 border-black px-6 py-4 font-bold text-lg focus:outline-none focus:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rounded-xl"
                  disabled={loading}
                />
                <button 
                  onClick={handleSubmit}
                  disabled={loading}
                  className="border-3 border-black bg-black text-white px-8 py-4 font-black hover:bg-[#ff6b6b] hover:text-black transition-all rounded-xl disabled:opacity-50 disabled:cursor-not-allowed"
                >
              ...
              {submitted && (
                <div className="border-3 border-black bg-[#ffe66d] px-4 py-3 mt-3 fade-in rounded-lg">
                  <p className="font-bold text-sm">✓ You're on the list! Check your email for confirmation.</p>
                </div>
              )}
              {error && (
          ...
          <div className="relative slide-in-right">
            <div className="border-4 border-black bg-white p-4 transform rotate-2 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:rotate-0 transition-transform rounded-xl">
              <img 
            ...
            <div className="absolute -top-4 -right-4 border-3 border-black bg-[#ffe66d] px-6 py-4 transform rotate-6 shadow-lg pulse rounded-xl">
              <p className="font-black text-center">LAUNCHING<br/>JANUARY<br/>2026</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Countdown */}
      <section className="border-y-4 border-black bg-[#ff6b6b] py-12 fade-in">
        <div className="max-w-6xl mx-auto px-8">
          <div className="text-center">
            <p className="text-white font-black text-2xl mb-4">LAUNCHING IN</p>
            <div className="flex justify-center gap-4">
              {[
                ...
                <div key={i} className="border-4 border-black bg-white p-4 min-w-[90px] rounded-xl">
      ...
      <section className="max-w-6xl mx-auto px-8 py-24">
        <div className="mb-16 slide-in-left">
          <div className="flex items-center gap-6 mb-4">
            <h2 className="text-6xl font-black">WHAT WE'RE BUILDING</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {[
            ...
            <div 
              key={i} 
              className="border-4 border-black p-8 bg-white hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all slide-in-right rounded-xl"
        ...
        <div className="border-4 border-black p-12 bg-[#ffe66d] transform -rotate-1 hover:rotate-0 transition-transform rounded-xl">
          <h3 className="text-4xl font-black mb-6">OUR TARGET</h3>
          <div className="grid md:grid-cols-4 gap-8">
            {[
              { number: "1,300+", label: "Cups per week by Month 3" },
              { number: "£24K", label: "Monthly revenue target" },
              { number: "5", label: "UCL students running this" },
        ...
        <div className="border-4 border-black p-12 bg-white mt-16 rounded-xl">
          <div className="text-center mb-8">
            <div className="inline-block border-3 border-black bg-[#ff6b6b] text-white px-8 py-4 rounded-xl mb-6">
              <p className="font-black text-2xl">⚡ EARLY BIRD SPECIAL</p>
            </div>
            <h3 className="text-5xl font-black mb-6">LIFETIME DISCOUNT FOR FIRST 100</h3>
          </div>
          
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="border-4 border-black p-8 bg-[#ffe66d] rounded-xl">
              <div className="text-6xl mb-4 text-center">🏆</div>
              <h4 className="text-2xl font-black mb-4 text-center">FIRST 100 SIGNUPS</h4>
            ...
            <div className="border-4 border-black p-8 bg-white rounded-xl">
              <div className="text-6xl mb-4 text-center">🎁</div>
              <h4 className="text-2xl font-black mb-4 text-center">SIGNUPS 101-500</h4>
              <p className="text-lg leading-relaxed mb-4">
      ...
      <section className="bg-white border-y-4 border-black py-24">
        <div className="max-w-6xl mx-auto px-8">
          <div className="mb-16">
            <div className="flex items-center gap-6 mb-4">
              <h2 className="text-6xl font-black">THE MENU</h2>
              <div className="flex-1 border-t-4 border-black"></div>
            </div>
            <p className="text-xl max-w-2xl">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="border-4 border-black p-8 bg-[#fef6e4] hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all rounded-xl">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <div className="text-sm font-black text-[#ff6b6b] mb-2">SMALL CUP</div>
                  <h3 className="text-5xl font-black mb-2">£3.00</h3>
                  <p className="font-bold text-lg">Two strawberries</p>
                </div>
            ...
            <div className="border-4 border-black p-8 bg-[#ff6b6b] text-white hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all rounded-xl">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <div className="text-sm font-black mb-2">LARGE CUP</div>
                  <h3 className="text-5xl font-black mb-2">£7.50</h3>
                  <p className="font-bold text-lg">10-12 strawberries</p>
                </div>
              ...
              <div className="border-t-2 border-white pt-6 space-y-4">
                ...
                <div className="border-2 border-white p-4 bg-white text-black rounded-lg">
                  <p className="text-sm font-bold">
          ...
          <div className="border-4 border-black p-8 bg-[#ffe66d] mt-8 rounded-xl">
            <h3 className="text-3xl font-black mb-6">CHOCOLATE OPTIONS</h3>
              ...
              {[
                ...
                <div key={i} className="slide-in-left" style={{ animationDelay: `${i * 0.2}s` }}>
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-12 h-12 border-2 border-black rounded-lg" style={{ backgroundColor: choc.color }}></div>
                    <h4 className="text-xl font-black">{choc.name}</h4>
                  </div>
                  <p className="text-sm leading-relaxed">{choc.desc}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-8 py-24">
        <div className="mb-16">
          <div className="flex items-center gap-6 mb-4">
            <h2 className="text-6xl font-black">WHO WE ARE</h2>
            <div className="flex-1 border-t-4 border-black"></div>
          </div>
          <p className="text-xl max-w-2xl">
        ...
        <div className="space-y-6 text-lg leading-relaxed mb-12">
          ...
          <div className="border-4 border-black p-8 bg-white slide-in-right rounded-xl">
            <p className="leading-relaxed">
          ...
          <div className="border-4 border-black p-8 bg-[#ff6b6b] text-white slide-in-right rounded-xl">
            <h3 className="text-2xl font-black mb-4">OUR PROMISE</h3>
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <span className="text-2xl">✓</span>
                <span>Fresh strawberries bought same morning, every single day</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-2xl">✓</span>
                <span>Belgian chocolate, properly tempered, no cheap alternatives</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-2xl">✓</span>
                <span>Fair pricing - £3 small, £7.50 large, no surge pricing</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-2xl">✓</span>
                <span>Consistent schedule - same times, same location, every weekday</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <div 
              key={i} 
              className="border-4 border-black p-6 bg-[#ffe66d] text-center hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] transition-all rounded-xl"
            >
              <h4 className="text-xl font-black mb-3">{role.role}</h4>
      ...
      <section className="bg-white border-y-4 border-black py-24">
        <div className="max-w-6xl mx-auto px-8">
          <div className="mb-16">
            <h2 className="text-6xl font-black mb-4">LAUNCH ROADMAP</h2>
            <p className="text-xl">Here's exactly how we're getting to January 2026.</p>
          </div>
          ...
          <div className="space-y-8">
            {[
              ...
              <div 
                key={i} 
                className="border-4 border-black p-8 hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all fade-in rounded-xl"
                style={{ animationDelay: `${i * 0.3}s` }}
              >
                <div className="flex items-center gap-4 mb-6">
                  <div 
                    className="border-3 border-black px-6 py-3 font-black text-lg rounded-lg"
                    style={{ backgroundColor: phase.color }}
                  >
                    {phase.month}
                  </div>
                  <div className="text-sm font-black">{phase.status}</div>
                </div>
                <ul className="space-y-3">
      ...
      <section className="max-w-6xl mx-auto px-8 py-24">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="border-4 border-black p-8 bg-white rounded-xl">
            <h3 className="text-2xl font-black mb-6">LOCATION DETAILS</h3>
            <div className="space-y-4">
              ...
              <div className="border-t-2 border-black pt-4">
                <p className="font-black mb-2">GETTING HERE</p>
          ...
          <div className="border-4 border-black p-8 bg-[#ffe66d] rounded-xl">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={i} className="border-2 border-black p-4 bg-white font-black rounded-lg">
                  {day}
                </div>
              ))}
              <div className="border-2 border-black p-4 bg-black text-white font-black rounded-lg">
      ...
      {/* Final CTA */}
      <section id="final-cta" className="bg-[#ff6b6b] border-y-4 border-black py-24">
        <div className="max-w-4xl mx-auto px-8 text-center text-white">
          <div className="inline-block border-4 border-black bg-[#ffe66d] text-black px-8 py-4 mb-8 rounded-xl transform -rotate-2">
            <p className="font-black text-xl">⚡ ONLY 500 SPOTS AVAILABLE</p>
          </div>
          
          <h2 className="text-7xl font-black mb-6">JOIN THE WAITLIST</h2>
          
          <div className="border-4 border-white bg-white text-black p-8 mb-8 rounded-xl">
            <p className="text-3xl font-black mb-4">SPECIAL EARLY BIRD OFFER</p>
          ...
          <div className="max-w-2xl mx-auto mb-8">
            <div className="flex gap-4">
              <input 
                ...
                onKeyPress={(e) => e.key === 'Enter' && handleSubmit()}
                placeholder="your.email@ucl.ac.uk"
                className="flex-1 border-4 border-black px-8 py-6 font-bold text-xl text-black focus:outline-none rounded-xl"
                disabled={loading}
              />
              <button 
                onClick={handleSubmit}
                disabled={loading}
                className="border-4 border-black bg-black text-white px-12 py-6 font-black text-xl hover:bg-white hover:text-black transition-all rounded-xl disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? 'JOINING...' : 'SIGN UP'}
              </button>
            </div>
            {submitted && (
              <div className="border-4 border-black bg-[#ffe66d] px-6 py-4 mt-4 fade-in rounded-lg">
                <p className="font-black text-black text-lg">✓ YOU'RE IN! Check your email for confirmation.</p>
              </div>
            )}
            {error && (
              <div className="border-4 border-black bg-red-100 px-6 py-4 mt-4 rounded-lg">
                <p className="font-black text-red-700 text-lg">{error}</p>
              </div>
            )}
          </div>

          <div className="border-t-4 border-white pt-8">
            <p className="text-xl font-bold">387 students on the waitlist • 113 lifetime discount spots remaining</p>
          </div>
        </div>
      </section>

      {/* Footer */}
      <footer className="border-t-4 border-black bg-[#fef6e4] py-16">
        <div className="max-w-6xl mx-auto px-8">
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            <div>
              <div className="flex items-center gap-3 mb-4">
                {logoUrl ? (
                  ...
                  <div className="w-14 h-14 border-4 border-black bg-[#ff6b6b] rounded-xl flex items-center justify-center pulse">
                    <span className="text-2xl">🍓</span>
                  </div>
                )}
                <span className="text-2xl font-black">BLOOMSBERRY</span>
              </div>
            ...
            <div>
              <h4 className="font-black mb-4">LAUNCHING</h4>
          ...
          <div className="border-t-2 border-black pt-8 flex justify-between items-center">
            <p className="text-sm font-black">© 2025 BLOOMSBERRY</p>
            <p className="text-xs">Launching January 2026 • Gordon Square, UCL</p>
          </div>
        </div>
      </footer>
      ...
      <div className="fixed bottom-8 right-8 z-40">
        <div className="relative pulse">
          <div className="absolute -top-3 -right-3 bg-[#ff6b6b] border-2 border-black rounded-full w-8 h-8 flex items-center justify-center text-xs font-black text-white">
            113
          </div>
          <button 
            onClick={() => document.querySelector('#final-cta')?.scrollIntoView({ behavior: 'smooth' })}
            className="border-4 border-black bg-[#ffe66d] px-8 py-4 font-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all rounded-xl"
          >
            JOIN WAITLIST
          </button>
        </div>
